...
class UpdateStudentComponent extends Component {
    constructor(props) {
        ...
        this.changeStudentSurnameHandler = this.changeStudentSurnameHandler.bind(this);
    ...
    updateThisStudent = (e) => {
        e.preventDefault();
        let student = { studentName: this.state.studentName, studentSurname: this.state.studentSurname, studentEmail: this.state.studentEmail };
                            ...
                            <div className="card-body">
                                <form>
                                    <div className="form-group">
                                        ...
                                        <input placeholder="Öğrenci Adı" name="studentName" className="form-control"
                                            value={this.state.studentName} onChange={this.changeStudentNameHandler} />
                                    </div>
                                    <div className="form-group">
                                        <label> Öğrenci Soyadı: </label>
                                        <input placeholder="Öğrenci Soyadı" name="studentSurname" className="form-control"
                                            value={this.state.studentSurname} onChange={this.changeStudentSurnameHandler} />
                                    </div>
                                    <div className="form-group">
                                        <label>  Öğrenci Email : </label>
                                        <input placeholder="Öğrenci Email" name="studentEmail" className="form-control"
                                            value={this.state.studentEmail} onChange={this.changeStudentEmailHandler} />
                                    </div>

                                    <button className="btn btn-success" onClick={this.updateThisStudent}>Kaydet</button>
                                    <button className="btn btn-danger" onClick={this.cancel.bind(this)} style={{ marginLeft: "10px" }}>Geri</button>
                                </form>
                            </div>
                        </div>
                    </div>
